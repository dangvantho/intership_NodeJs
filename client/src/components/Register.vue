  ...
  <div class="modal">
    <div class="modal-body">
      <form ref="form">
        ...
        <div class="btn-submit btn-register" @click="submit">Đăng ký</div>
        <span class="text"></span>
        <div class="btn-submit" @click="$emit('toggleRegister', true)">
          Đăng nhập
        </div>
      </form>
...
export default {
  ...
  watch: {
    ...
    password(newValue){
      let regex = /^.{8,20}$/g;
      this.validate("password", newValue, "Password phải từ 8-20 ký tự", regex);
    },
